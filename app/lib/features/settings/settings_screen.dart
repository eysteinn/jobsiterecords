      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            onTap: () => _launchUrl('https://sitelog.app/waitlist'),
          ),
          ListTile(
            leading: const Icon(Icons.mail_outline),
            title: const Text('Send feedback'),
            subtitle: const Text('Tell us what works and what is missing.'),
            onTap: () => _launchUrl('mailto:feedback@sitelog.app?subject=SiteLog%20feedback'),
          ),
          const _SectionHeader('About'),
          const ListTile(
            leading: Icon(Icons.info_outline),
            title: Text('SiteLog'),
            subtitle: Text('Version 0.1.0 — local-only MVP.\nData stays on your device.'),
          ),
          ListTile(
            leading: const Icon(Icons.policy_outlined),
            title: const Text('Privacy policy'),
            onTap: () => _launchUrl('https://sitelog.app/privacy'),
          ),
